...
const FAQS = [
  {
    ...
    a: "Picosure Pro 皮秒雷射搭載 755nm 波長搭配蜂巢透鏡，相較常見的 1064nm 皮秒，對黑色素選擇性較高。蜂巢透鏡能觸發 LIOB 光震波效應，有助於促進真皮層膠原蛋白新生。實際效果因個人膚況而異，需由醫師評估後說明。",
  },
  {
    q: "術後需要請假休息嗎？",
    a: "755nm 波長對血管迴避性較高，術後多數人僅有輕微泛紅反應。實際恢復時間因個人體質、能量設定與治療範圍而異，建議諮詢時向醫師確認您的狀況。",
  },
  {
    q: "皮秒雷射打多了會讓皮膚變薄嗎？",
    a: "Picosure Pro 以物理壓力波機制運作，有助於減少熱傷害對角質層的影響。臨床觀察顯示，在適當能量與頻次下，對肌膚環境較為友善。實際治療方案需由醫師根據您的膚況評估。",
  },
  {
    q: "第一次體驗需要多少預算？",
    a: "每個人的膚況不同，適合的能量與治療範圍也不一樣。建議先預約專業諮詢，由醫師評估後提供個人化的方案與費用說明，不用擔心到院後被強迫消費。",
  },
  {
    q: "肝斑可以打 Picosure Pro 嗎？",
    a: "肝斑是常見但複雜的色素問題。755nm 波長因對血管的迴避性較高，有助於降低因發炎引發的色素沉澱風險。是否適合、能量設定、療程規劃等，需由醫師根據個人膚況進行專業評估。",
  },
];
</script>
